...
/**
* Obsluguje blad zwiazany z otwarciem pliku. Prosi uzytkownika o podanie sciezki wzglednej do pliku 
* z kodem o wczesniej podanym formacie w przypadku bledu i zwraca ja jako ciag znakow.
*/
char* handleFileOpenError();
/**
* Czyta linie tekstu, na ktora obecnie wskazuje wskaznik na obiekt typu FILE przekazywany w argumencie.
